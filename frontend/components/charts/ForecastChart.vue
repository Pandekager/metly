    ...
    <div class="forecast-chart-container">
        <div class="top-section">
            ...
            <div class="monthly-cards">
                <div
                    v-for="([month, summary], index) in Object.entries(
                        monthlySummaries,
                    )"
                    :key="month"
                ...
                >
                    <h3
                        class="text-lg font-normal text-slate-800 dark:text-slate-200 mb-2"
                    >
                        {{ month }}
                    </h3>
                    <p
                    ...
                    >
                        {{
                            summary.hasForecast ? "Forventet" : "Faktisk"
                        }}
                        salg: {{ summary.amount || 0 }} stk.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="chart-wrapper">
            ...
            <div v-else class="empty-state">
                <p class="empty-text text-slate-500 dark:text-slate-400">
                    Ingen data tilgængelig for den valgte kategori
                </p>
            </div>
        </div>
    </div>
...
const chartData = computed(() => {
    ...
    const forecastData = sortedData.map((f) =>
        f.is_forecast ? f.amount : null,
    );
