...
```bash
cd /home/rasmus/Work/metly_backend
...
1. `/home/rasmus/Work/metly_backend/src/endpoints/getData.py`
...
2. `/home/rasmus/Work/metly_backend/src/scripts/db/createDB.py`

   - Added password hashing for new users
   - Display temporary password to admin

3. `/home/rasmus/Work/metly_backend/scripts/migrate_passwords.py` (new)
